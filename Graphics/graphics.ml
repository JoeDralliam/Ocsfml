...
object
  external method create_from_color : ?color:Color.t -> int -> int -> unit = ""
  external method create_from_pixels : int -> int -> string (* should it be a bigarray ? *) -> unit = ""
  external method load_from_file : string -> bool = ""
  external method load_from_memory : string -> bool = ""
  external method load_from_stream : System.input_stream -> bool = ""
  external method save_to_file : string -> bool = ""
  external method get_height : unit -> int = ""
  external method get_width : unit -> int = ""
  external method create_mask_from_color : ?alpha:int -> Color.t = ""
  external method copy :  ?srcRect:int rect -> ?alpha:bool -> image -> int -> int -> unit = ""
  external method set_pixel : int -> int -> Color.t -> unit = ""
  external method get_pixel : int -> int -> Color.t = ""
  external method get_pixels : unit -> string (* bigarray !!! *) = ""
  external method flip_horizontally : unit -> unit = ""
  external method flip_vertically : unit -> unit = ""
end
